...
router.route("/update-coverimage").patch(verifyJWT,upload.single('coverImage'),updateUserAvatar)
router.route("/c/:username").get(verifyJWT,getUserChannelProfile)
router.route("/watch-history").get(verifyJWT,getUserChannelProfile)
